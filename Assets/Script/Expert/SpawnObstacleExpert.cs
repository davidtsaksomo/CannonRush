...
public class SpawnObstacleExpert : MonoBehaviour {
	...
	void Update () {
		...
		bolameriam.GetComponent<ObstacleMovementExpert> ().speedObs = speedObs;
	...
	void TimeControl(){
		if (limits == false) {
			...
			Invoke ("SpawningMeriam2", (1f * l / spawnSpeed) + 0.5f);
		} else {
			Start ();
		}
